#include <netdb.h>     /* addrinfo, AF_INET, SOCK_STREAM */
...
void http_get_task(void *pvParameters)
{
    ...
    while (1) {
        ...
        /* TODO: cambiar inet_ntoa por ipaddr_ntoa_r, versión reentrante */
        ...
        ESP_LOGI(TAG, "Done reading from socket. Las read return: %d, " \
                "errno: %d\r\n", r, errno);
        close(s);
